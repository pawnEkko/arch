...
> NeoVim使用了LazyVim的框架，单独有一个仓库，这里只做简略介绍
>
> 详细介绍、配置、使用请转[NeoVim单独仓库](https://github.com/pawnEkko/LazyNvim)
...
3. 我的NeoVim配置文件在GitHub的仓库路径

```
https://github.com/pawnEkko/LazyNvim
```

4. 详细配置详情在GitHub仓库中，可以使用以下命令一键下载配置文件

```
git https://github.com/pawnEkko/LazyNvim ~/.config/nvim
```
